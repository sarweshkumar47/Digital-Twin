...
.LFB394:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var1C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var14ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L10
...
.L18:
	...
	orr	r3, r3, r2
	strb	r3, [sp]
	bl	_ZN8opendnp311Group42Var15WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #12
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L24:
...
.LFB401:
	...
	mov	r0, r4
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var2C1Ev(PLT)
	mov	r0, r6
	mov	r1, r4
	bl	_ZN8opendnp311Group42Var24ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L37
	ldrsh	r3, [sp, #6]
	add	r4, sp, #8
...
.L43:
	...
	strb	r2, [sp, #12]
	strh	r3, [sp, #14]	@ movhi
	bl	_ZN8opendnp311Group42Var25WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #20
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L47:
...
.LFB408:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var3C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var34ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L71
	vldr.32	s15, [sp, #4]	@ int
	add	r4, sp, #16
...
.L79:
	...
	strb	r3, [sp]
	strd	r4, [sp, #8]
	bl	_ZN8opendnp311Group42Var35WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #20
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L85:
...
.LFB415:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var4C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var44ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L111
	ldrsh	r3, [sp, #2]
	add	r4, sp, #16
...
.L119:
	...
	strb	r3, [sp]
	strd	r4, [sp, #8]
	bl	_ZN8opendnp311Group42Var45WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #20
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L125:
...
.LFB422:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var5C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var54ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L138
	vldr.32	s0, [sp, #4]
	add	r4, sp, #8
...
.L146:
	...
	orr	r3, r3, r2
	strb	r3, [sp]
	bl	_ZN8opendnp311Group42Var55WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #12
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L152:
...
.LFB429:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var6C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var64ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L166
	add	r4, sp, #16
	ldrb	r1, [sp]	@ zero_extendqisi2
...
.LFB430:
	...
	strd	r6, [sp, #8]
	strb	r3, [sp]
	bl	_ZN8opendnp311Group42Var65WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #16
	@ sp needed
...
.LFB436:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var7C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var74ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L194
	vldr.32	s0, [sp, #4]
	add	r4, sp, #16
...
.L202:
	...
	strb	r3, [sp]
	strd	r4, [sp, #8]
	bl	_ZN8opendnp311Group42Var75WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #20
	@ sp needed
	pop	{r4, r5, r6, r7, pc}
.L208:
...
.LFB443:
	...
	mov	r0, sp
	mov	r5, r1
	bl	_ZN8opendnp311Group42Var8C1Ev(PLT)
	mov	r0, r6
	mov	r1, sp
	bl	_ZN8opendnp311Group42Var84ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L234
	add	r4, sp, #24
	ldrd	r2, [sp, #16]
...
.LFB444:
	...
	strb	ip, [sp]
	strd	r2, [sp, #16]
	bl	_ZN8opendnp311Group42Var85WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #24
	@ sp needed
	pop	{r4, r5, r6, r7, r8, pc}
	.fnend
...
.L254:
	...
	.align	2
	.word	_GLOBAL__sub_I_Group42.cpp

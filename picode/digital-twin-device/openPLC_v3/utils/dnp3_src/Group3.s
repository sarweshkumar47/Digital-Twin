...
.LFB394:
	...
	mov	r0, r4
	mov	r5, r1
	bl	_ZN8opendnp310Group3Var2C1Ev(PLT)
	mov	r0, r6
	mov	r1, r4
	bl	_ZN8opendnp310Group3Var24ReadERN7openpal6RSliceERS0_(PLT)
	subs	r6, r0, #0
	beq	.L5
	add	r4, sp, #8
...
.LFB395:
	...
	mov	r0, r4
	strb	r3, [sp, #4]
	bl	_ZN8opendnp310Group3Var25WriteERKS0_RN7openpal6WSliceE(PLT)
	add	sp, sp, #8
	@ sp needed
	pop	{r4, r5, r6, pc}
	.fnend
